...
export const metadata: Metadata = {
  title: "Blog Details Page | Free Next.js Template for Kinesis and SaaS",
  description: "This is Blog Details Page for Kinesis Nextjs Template",
  // other metadata
};
